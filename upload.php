...
<head>
    ...
    <body class="body-after-login">
        <div style="position: relative; padding-bottom: 15%; padding-top: 5%;" class="d-flex flex-column">
            ...
            <div style="width: 100%; height: 450px; border-style: hidden;" class="border-upload d-flex justify-content-center">
                <div style="width: 45%; height: 350px; margin: auto; border-color: white;" class="border-upload d-flex flex-column">
                    <div style="margin: auto;">
                        <!-- <div class="d-flex justify-content-center">
                            <h4 style="color: white; padding-bottom: 1px;"> Drag and Drop </h4>
                        </div>
                        <div class="d-flex justify-content-center">
                        ...
                        <form action="/" method="post" class="dropzone" id="my-awesome-dropzone" enctype="multipart/form-data" action="__URL__"></form>
                    </div>
                </div>
                <div style="margin: auto;">
